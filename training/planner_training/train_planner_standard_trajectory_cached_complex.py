"""
Train Action Planner - Cached Embeddings Mode

Fine-tune Qwen3-VL using pre-computed vision embeddings for 3× speedup.
"""
...
from training.planner_training.planner_dataset_cached import create_dataloaders


def load_config(config_path: str = None):
    """Load training configuration."""
    if config_path is None:
        config_path = SCRIPT_DIR / "configs_complex_8b" / "planner_config_standard_trajectory_cached.yaml"
...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs_complex_8b/planner_config_standard_trajectory_cached.yaml",
        help="Path to config file (default: configs_complex_8b/planner_config_standard_trajectory_cached.yaml)"
    )
    parser.add_argument(
        "--data-path",
        type=str,
    ...
    print("=" * 60)
    print("🧠 Action Planner Training - Cached Embeddings Mode")
    print("=" * 60)
    print()
    ...
    # Start training
    print("\n" + "=" * 60)
    print("🚀 Starting Training (Cached Embeddings)")
    print("=" * 60)
    print()
