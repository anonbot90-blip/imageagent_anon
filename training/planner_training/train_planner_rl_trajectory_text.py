...
def load_config(config_path: str = None):
    ...
    if config_path is None:
        config_path = SCRIPT_DIR / "planner_config_rl_trajectory_text.yaml"
...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="planner_config_rl_trajectory_text.yaml",
        help="Path to config file (default: planner_config_rl_trajectory_text.yaml)"
    )
    parser.add_argument(
        "--data-path",
        type=str,
