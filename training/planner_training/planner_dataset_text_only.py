"""
Planner Training Dataset - Text-Only Version

Dataset for fine-tuning Qwen3-VL to predict action plans using ONLY text prompts
(no images). This is much faster but less context-aware.

Use case: Fast iterations, testing prompt engineering, low-resource training.
"""
...
class PlannerDatasetTextOnly(Dataset):
    """
    ...
    def __init__(
        ...
        print(f"Loaded {len(self.data)} training samples (text-only mode)")
