...
def load_config(config_path: str = None):
    ...
    if config_path is None:
        config_path = SCRIPT_DIR / "configs_complex_8b" / "planner_config_dpo_trajectory_text.yaml"
...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs_complex_8b/planner_config_dpo_trajectory_text.yaml",
        help="Path to config file (default: configs_complex_8b/planner_config_dpo_trajectory_text.yaml)"
    )
    parser.add_argument(
        "--data-path",
        type=str,
    ...
    print(f"✓ Reference model created on {device} and weights copied")
