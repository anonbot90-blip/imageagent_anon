...
def load_config(config_path: str = None):
    ...
    if config_path is None:
        config_path = SCRIPT_DIR / "planner_config_rw_trajectory_cached.yaml"
...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="planner_config_rw_trajectory_cached.yaml",
        help="Path to config file (default: planner_config_rw_trajectory_cached.yaml)"
    )
    parser.add_argument(
        "--data-path",
        type=str,
