"""
Planner Training Dataset - RL Trajectory-Based (Text-Only)

Dataset for RL-filtered training with trajectory-based split.
Only includes trajectories with average reward >= 3.0.
"""
...
class PlannerDatasetRLTrajectoryTextComplex(Dataset):
    """
    ...
    def __init__(
        ...
        print(f"Loaded {len(self.data)} training samples (RL trajectory-based, text-only mode)")
