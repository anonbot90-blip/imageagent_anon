...
from training.planner_training.planner_dataset_sw_trajectory_text import create_dataloaders
...
def load_config(config_path: str = None):
    ...
    if config_path is None:
        config_path = SCRIPT_DIR / "planner_config_sw_trajectory_text.yaml"
...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="planner_config_sw_trajectory_text.yaml",
