...
# Full Text-Only Training Pipeline (Trajectory-Based) - NORMAL Dataset 4B
...
print_header "Step 1/7: Verify Trajectory Split (NORMAL 10K - 4B Model)"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun \
    ...
    --config configs_4b/planner_config_standard_trajectory_text.yaml
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun \
    ...
    --config configs_4b/planner_config_rl_trajectory_text.yaml
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun \
    ...
    --config configs_4b/planner_config_rw_trajectory_text.yaml
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun \
    ...
    --config configs_4b/planner_config_dpo_trajectory_text.yaml
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun \
    ...
    --config configs_4b/planner_config_sw_trajectory_text.yaml
...
print_header "📈 Evaluate Text-Only Models (NORMAL 10K - 4B)"
...
echo -e "${CYAN}  - SW Text-Only 4B (trajectory-standardized weighted training)${NC}"
...
# Use unified config-based evaluation for normal 4B
bash scripts/evaluation/run_parallel_evaluation.sh \
    --config scripts/evaluation/configs/normal_text_4b.yaml
...
print_header "🎉 NORMAL Dataset 4B Training & Evaluation Complete!"
...
echo -e "${CYAN}   Evaluation: evaluation_results/normal/text_parallel_cot_4b_trajectory/${NC}"
echo ""

echo -e "${YELLOW}💡 Next steps:${NC}"
echo -e "${YELLOW}   - Review evaluation results${NC}"
echo -e "${YELLOW}   - Compare with 8B model (evaluation_results/normal/text_parallel_cot_8b_trajectory/)${NC}"
echo ""
