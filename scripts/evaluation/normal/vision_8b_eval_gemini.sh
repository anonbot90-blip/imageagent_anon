#!/bin/bash
# Evaluate Gemini 2.5 planner on 8B vision trajectory samples (normal/regular dataset)
...
ACTION_LIBRARY="$PROJECT_ROOT/actions/action_library_normal.json"
...
TEMP_SAMPLE_IDS="/tmp/gemini_eval_normal_vision8b_$$.txt"
