#!/bin/bash
# Parallel evaluation for Complex V2 8B vision models
...
TEST_SAMPLES_FILE="$PROJECT_ROOT/training_data/complex_v2_cot_8b_trajectory/test_samples_complex_v2_cot_8b.txt"
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/vision_parallel_complex_v2_cot_8b_trajectory"
NUM_SAMPLES=200
EVAL_CHECKPOINT=10
...
STANDARD_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_8b_trajectory/vision/standard/final"
RL_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_8b_trajectory/vision/rl/final"
RW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_8b_trajectory/vision/rw/final"
DPO_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_8b_trajectory/vision/dpo/final"
SW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_8b_trajectory/vision/sw/final"
...
echo "════════════════════════════════════════════════════════════════════════════════"
echo "  VISION PARALLEL EVALUATION - COMPLEX V2 8B MODELS"
echo "════════════════════════════════════════════════════════════════════════════════"
echo ""
echo "Evaluating 7 models in parallel (Complex V2 - 8B Vision):"
...
echo "════════════════════════════════════════════════════════════════════════════════"
echo "✅ Evaluation Complete - Complex V2 8B Vision Models"
echo "════════════════════════════════════════════════════════════════════════════════"
