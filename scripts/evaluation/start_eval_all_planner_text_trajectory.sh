...
TEST_SAMPLES_FILE="$PROJECT_ROOT/training_data/cot_8b_trajectory/test_samples_cot_8b.txt"
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/text_parallel_cot_8b_trajectory"
NUM_SAMPLES=200  # Evaluate on low-quality test samples (trajectory-based split)
EVAL_CHECKPOINT=10  # Generate tables after every N samples (0 = only at end)
...
STANDARD_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/standard/final"
RL_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/rl/final"
RW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/rw/final"
DPO_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/dpo/final"
SW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/sw/final"
...
Options:
  ...
  --output PATH                 Output base directory (default: evaluation_results/text_parallel_cot_8b_trajectory)
  ...
  --standard-text-checkpoint P  Standard Text checkpoint (default: checkpoints/cot_8b_trajectory/standard/final)
  --rl-text-checkpoint P        RL Text checkpoint (default: checkpoints/cot_8b_trajectory/rl/final)
  --rw-text-checkpoint P        RW Text checkpoint (default: checkpoints/cot_8b_trajectory/rw/final)
  --dpo-text-checkpoint P       DPO Text checkpoint (default: checkpoints/cot_8b_trajectory/dpo/final)
...
# Update NUM_SAMPLES to match actual test set size if not specified
