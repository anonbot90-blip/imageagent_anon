#!/bin/bash
# Parallel evaluation for TRAJECTORY-BASED 4B baseline, standard, RL, RW, and DPO text-only models - 4B
# TEXT-ONLY TRAJECTORY EXPERIMENT (4B): Runs 7 models in PARALLEL on 7 different GPUs
...
DATA_PATH="$PROJECT_ROOT/training_data/complex_cot_4b_trajectory/full_dataset_for_eval.json"
TEST_SAMPLES_FILE="$PROJECT_ROOT/training_data/complex_cot_4b_trajectory/test_samples_complex_cot_4b.txt"
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/text_parallel_complex_cot_4b_trajectory"
...
STANDARD_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/standard/final"
RL_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/rl/final"
RW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/rw/final"
DPO_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/dpo/final"
SW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/sw/final"
...
text-only models trained with trajectory-based approach on the SAME samples using 7 GPUs in parallel.

Options:
  --data PATH                   Path to evaluation data (default: training_data/complex_cot_4b_trajectory/full_dataset_for_eval.json)
  --output PATH                 Output base directory (default: evaluation_results/text_parallel_complex_cot_4b_trajectory)
  ...
  --standard-text-checkpoint P  Standard Text checkpoint (default: checkpoints/complex_cot_4b_trajectory/standard/final)
  --rl-text-checkpoint P        RL Text checkpoint (default: checkpoints/complex_cot_4b_trajectory/rl/final)
  --rw-text-checkpoint P        RW Text checkpoint (default: checkpoints/complex_cot_4b_trajectory/rw/final)
  --dpo-text-checkpoint P       DPO Text checkpoint (default: checkpoints/complex_cot_4b_trajectory/dpo/final)
  --sw-text-checkpoint P        SW Text checkpoint (default: checkpoints/complex_cot_4b_trajectory/sw/final)
...
echo ""
echo "Models to evaluate: 7 (Baseline, Edit-Only, Standard, RL, RW, DPO, SW Text-Only Trajectory)"
