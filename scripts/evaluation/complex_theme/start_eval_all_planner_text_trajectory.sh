...
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/text_parallel_complex_cot_8b_trajectory"
NUM_SAMPLES=10  # Evaluate on low-quality test samples (trajectory-based split)
...
STANDARD_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_8b_trajectory/standard/final"
RL_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_8b_trajectory/rl/final"
RW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_8b_trajectory/rw/final"
DPO_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_8b_trajectory/dpo/final"
SW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_8b_trajectory/sw/final"
...
Options:
  --data PATH                   Path to evaluation data (default: training_data/complex_cot_8b_trajectory/full_dataset_for_eval.json)
  --output PATH                 Output base directory (default: evaluation_results/text_parallel_complex_cot_8b_trajectory)
  ...
  --standard-text-checkpoint P  Standard Text checkpoint (default: checkpoints/complex_cot_8b_trajectory/standard/final)
  --rl-text-checkpoint P        RL Text checkpoint (default: checkpoints/complex_cot_8b_trajectory/rl/final)
  --rw-text-checkpoint P        RW Text checkpoint (default: checkpoints/complex_cot_8b_trajectory/rw/final)
  --dpo-text-checkpoint P       DPO Text checkpoint (default: checkpoints/complex_cot_8b_trajectory/dpo/final)
