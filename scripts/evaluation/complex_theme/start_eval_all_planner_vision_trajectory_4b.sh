...
STANDARD_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/vision/standard/final"
RL_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/vision/rl/final"
RW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/vision/rw/final"
DPO_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/vision/dpo/final"
SW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_cot_4b_trajectory/vision/sw/final"
