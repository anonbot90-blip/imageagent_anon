...
echo "───────────────────────────────────────────────────────────────────────────"
bash "$PROJECT_ROOT/scripts/evaluation/complex/text_8b_eval_gpt4o.sh" --num-samples "$NUM_SAMPLES"

echo ""
echo "───────────────────────────────────────────────────────────────────────────"
echo "2/4: Running 4B Text evaluation..."
echo "───────────────────────────────────────────────────────────────────────────"
bash "$PROJECT_ROOT/scripts/evaluation/complex/text_4b_eval_gpt4o.sh" --num-samples "$NUM_SAMPLES"

echo ""
echo "───────────────────────────────────────────────────────────────────────────"
echo "3/4: Running 8B Vision evaluation..."
echo "───────────────────────────────────────────────────────────────────────────"
bash "$PROJECT_ROOT/scripts/evaluation/complex/vision_8b_eval_gpt4o.sh" --num-samples "$NUM_SAMPLES"

echo ""
echo "───────────────────────────────────────────────────────────────────────────"
echo "4/4: Running 4B Vision evaluation..."
echo "───────────────────────────────────────────────────────────────────────────"
bash "$PROJECT_ROOT/scripts/evaluation/complex/vision_4b_eval_gpt4o.sh" --num-samples "$NUM_SAMPLES"
