...
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/complex/vision_parallel_cot_4b_trajectory"
NUM_SAMPLES=4
EVAL_CHECKPOINT=2
...
STANDARD_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/vision/standard/final"
RL_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/vision/rl/final"
RW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/vision/rw/final"
DPO_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/vision/dpo/final"
SW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/vision/sw/final"
