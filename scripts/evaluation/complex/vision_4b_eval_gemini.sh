#!/bin/bash
# Evaluate Gemini 2.5 planner on 4B vision trajectory samples (complex dataset)

set -e

PROJECT_ROOT="$(git rev-parse --show-toplevel)"
DATA_PATH="$PROJECT_ROOT/training_data/complex/cot_4b_trajectory/full_dataset_for_eval.json"
...
TEMP_SAMPLE_IDS="/tmp/gemini_eval_complex_vision4b_$$.txt"
