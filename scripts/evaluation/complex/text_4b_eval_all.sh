#!/bin/bash
# Parallel evaluation for Complex V2 4B text-only models
...
TEST_SAMPLES_FILE="$PROJECT_ROOT/training_data/complex/cot_4b_trajectory/test_samples_cot_4b.txt"
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/complex/text_parallel_cot_4b_trajectory"
NUM_SAMPLES=4
EVAL_CHECKPOINT=2
...
STANDARD_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/standard/final"
RL_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/rl/final"
RW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/rw/final"
DPO_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/dpo/final"
SW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex/cot_4b_trajectory/sw/final"
...
echo "════════════════════════════════════════════════════════════════════════════════"
echo "  TEXT PARALLEL EVALUATION - COMPLEX V2 4B MODELS (TRAJECTORY-BASED)"
echo "════════════════════════════════════════════════════════════════════════════════"
echo ""
echo "Evaluating 7 models in parallel (Complex V2 - 4B):"
echo "  [GPU $BASELINE_GPU] Baseline (Qwen3-VL-4B-Instruct)"
...
echo "════════════════════════════════════════════════════════════════════════════════"
echo "✅ Evaluation Complete - Complex V2 4B Text Models"
echo "════════════════════════════════════════════════════════════════════════════════"
