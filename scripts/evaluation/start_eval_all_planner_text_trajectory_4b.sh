...
TEST_SAMPLES_FILE="$PROJECT_ROOT/training_data/cot_4b_trajectory/test_samples_cot_4b.txt"
...
STANDARD_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_4b_trajectory/standard/final"
RL_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_4b_trajectory/rl/final"
RW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_4b_trajectory/rw/final"
DPO_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_4b_trajectory/dpo/final"
SW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_4b_trajectory/sw/final"
...
Options:
  --data PATH                   Path to evaluation data (default: training_data/cot_4b_trajectory/full_dataset_for_eval.json)
  --output PATH                 Output base directory (default: evaluation_results/text_parallel_cot_4b_trajectory)
  ...
  --standard-text-checkpoint P  Standard Text checkpoint (default: checkpoints/cot_4b_trajectory/standard/final)
  --rl-text-checkpoint P        RL Text checkpoint (default: checkpoints/cot_4b_trajectory/rl/final)
  --rw-text-checkpoint P        RW Text checkpoint (default: checkpoints/cot_4b_trajectory/rw/final)
  --dpo-text-checkpoint P       DPO Text checkpoint (default: checkpoints/cot_4b_trajectory/dpo/final)
  --sw-text-checkpoint P        SW Text checkpoint (default: checkpoints/cot_4b_trajectory/sw/final)
