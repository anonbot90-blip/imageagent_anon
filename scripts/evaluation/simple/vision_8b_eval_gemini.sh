#!/bin/bash
# Evaluate Gemini 2.5 planner on 8B vision trajectory samples (simple dataset)

set -e

PROJECT_ROOT="$(git rev-parse --show-toplevel)"
DATA_PATH="$PROJECT_ROOT/training_data/simple/cot_8b_trajectory/full_dataset_for_eval.json"
...
ACTION_LIBRARY="$PROJECT_ROOT/actions/action_library_simple.json"
...
TEMP_SAMPLE_IDS="/tmp/gemini_eval_vision8b_$$.txt"
