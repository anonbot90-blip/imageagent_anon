...
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/simple/vision_parallel_cot_8b_trajectory"
NUM_SAMPLES=4  # Evaluate on 200 low-quality test samples
...
STANDARD_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_8b_trajectory/vision/standard/final"
RL_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_8b_trajectory/vision/rl/final"
RW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_8b_trajectory/vision/rw/final"
DPO_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_8b_trajectory/vision/dpo/final"
SW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_8b_trajectory/vision/sw/final"
...
NUM_SAMPLES=4$NUM_TEST_SAMPLES
...
if [ $EVAL_CHECKPOINT -gt 0 ] && [ $EVAL_CHECKPOINT -le $NUM_SAMPLES ]; then
    ...
    while [ $CURRENT_SAMPLE -lt $TOTAL_SAMPLES ]; do
        ...
        if [ $? -eq 0 ]; then
            ...
            PNG_COUNT=$(ls "$CHECKPOINT_DIR"/*.png 2>/dev/null | wc -l)
