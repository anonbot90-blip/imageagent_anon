...
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/simple/text_parallel_cot_4b_trajectory"
...
STANDARD_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_4b_trajectory/standard/final"
RL_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_4b_trajectory/rl/final"
RW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_4b_trajectory/rw/final"
DPO_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_4b_trajectory/dpo/final"
SW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/simple/cot_4b_trajectory/sw/final"
...
Options:
  ...
  --standard-text-checkpoint P  Standard Text checkpoint (default: checkpoints/simple/cot_4b_trajectory/standard/final)
  --rl-text-checkpoint P        RL Text checkpoint (default: checkpoints/simple/cot_4b_trajectory/rl/final)
  --rw-text-checkpoint P        RW Text checkpoint (default: checkpoints/simple/cot_4b_trajectory/rw/final)
  --dpo-text-checkpoint P       DPO Text checkpoint (default: checkpoints/simple/cot_4b_trajectory/dpo/final)
  --sw-text-checkpoint P        SW Text checkpoint (default: checkpoints/simple/cot_4b_trajectory/sw/final)
...
echo ""
echo "Models to evaluate: 8 (Baseline, Edit-Only, Standard, RL, RW, DPO, SW, GPT-4o Planner Text-Only Trajectory)"
