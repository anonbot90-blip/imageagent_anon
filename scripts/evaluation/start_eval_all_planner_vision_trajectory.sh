...
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/vision_parallel_cot_8b_trajectory"
NUM_SAMPLES=200  # Evaluate on 200 low-quality test samples
...
STANDARD_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/vision/standard/final"
RL_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/vision/rl/final"
RW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/vision/rw/final"
DPO_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/vision/dpo/final"
SW_VISION_CHECKPOINT="$PROJECT_ROOT/checkpoints/cot_8b_trajectory/vision/sw/final"
