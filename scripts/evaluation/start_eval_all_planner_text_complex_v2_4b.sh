...
OUTPUT_BASE="$PROJECT_ROOT/evaluation_results/text_parallel_complex_v2_cot_4b_trajectory"
NUM_SAMPLES=200
EVAL_CHECKPOINT=10
...
STANDARD_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_4b_trajectory/standard/final"
RL_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_4b_trajectory/rl/final"
RW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_4b_trajectory/rw/final"
DPO_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_4b_trajectory/dpo/final"
SW_TEXT_CHECKPOINT="$PROJECT_ROOT/checkpoints/complex_v2_cot_4b_trajectory/sw/final"
