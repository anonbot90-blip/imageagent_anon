...
# Generate RL Training Data (Trajectory-Based) - Complex Theme
# Selects samples from trajectories with avg reward >= 3.0
# Quality-based filtering at trajectory level
...
echo ""
echo -e "${PURPLE}════════════════════════════════════════════════════════════════${NC}"
echo -e "${PURPLE}  Generate RL Training Data (Trajectory-Based)${NC}"
...
echo -e "${BLUE}Step 2/2: Generating RL vision training data...${NC}"
echo ""
...
echo -e "${GREEN}✓ RL vision training data generated (copied from text)${NC}"
echo ""
...
echo ""
echo -e "${PURPLE}════════════════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}✓ RL Training Data Generated (Trajectory-Based)${NC}"
echo -e "${PURPLE}════════════════════════════════════════════════════════════════${NC}"
echo ""
...
echo ""
echo "Strategy: Samples from trajectories with $REWARD_METRIC >= $REWARD_THRESHOLD"
echo ""
