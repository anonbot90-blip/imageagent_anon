...
# Generate RW (Reward-Weighted) Training Data for Complex V2 Dataset
# Includes ALL samples from ALL trajectories (threshold=0.0)
# Samples weighted by trajectory avg reward
...
echo ""
echo -e "${PURPLE}════════════════════════════════════════════════════════════════${NC}"
echo -e "${PURPLE}  Generate RW Training Data - Complex V2${NC}"
echo -e "${PURPLE}════════════════════════════════════════════════════════════════${NC}"
echo ""
echo "Trajectory Prefix: $TRAJECTORY_PREFIX"
echo "Results Directory: $RESULTS_DIR"
echo "Reward Threshold: $REWARD_THRESHOLD (includes ALL samples)"
echo ""
...
echo -e "  RW Strategy: ALL samples, weighted by trajectory avg reward"
echo ""
...
echo ""
echo -e "${PURPLE}════════════════════════════════════════════════════════════════${NC}"
echo -e "${GREEN}✓ RW Training Data Generated - Complex V2${NC}"
echo -e "${PURPLE}════════════════════════════════════════════════════════════════${NC}"
echo ""
...
echo ""
echo "Strategy: ALL samples, weighted by trajectory avg reward"
echo "Weighting:"
echo "  Trajectory avg 4.5-5.0 → weight 2.0"
echo "  Trajectory avg 4.0-4.5 → weight 1.5"
echo "  Trajectory avg 3.5-4.0 → weight 1.0"
echo "  Trajectory avg 3.0-3.5 → weight 0.5"
echo "Trajectory Prefix: $TRAJECTORY_PREFIX"
echo ""
