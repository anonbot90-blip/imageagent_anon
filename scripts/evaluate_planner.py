#!/usr/bin/env python3
"""
End-to-End Planner Evaluation with Optional Image Generation

This script evaluates the trained Qwen3-VL Action Planner with two modes:
...
class PlannerEvaluator:
    ...
    def _aggregate_gpt_action_scores(self, all_scores: List[Dict[str, float]]) -> Dict[str, float]:
        ...
        # GPT score dimensions - updated to include all 8 dimensions + 2 overall scores
        dimensions = [
